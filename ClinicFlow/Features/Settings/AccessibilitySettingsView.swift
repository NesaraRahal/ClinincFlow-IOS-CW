    ...
    var body: some View {
        List {
            ...
            Section {
                ...
                .onChange(of: hapticsManager.hapticsEnabled) { _, newValue in
                    if newValue {
            ...
            Section {
                ...
                .tint(Color(hex: "16A34A"))
                .onChange(of: hapticsManager.soundEnabled) { _, newValue in
                    if newValue {
            ...
            Section {
                ...
                .tint(Color(hex: "16A34A"))
                .onChange(of: hapticsManager.screenReaderEnabled) { _, newValue in
                    if newValue {
